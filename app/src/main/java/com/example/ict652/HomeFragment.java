...
public class HomeFragment extends Fragment implements RecyclerViewClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        floatingActionButton = view.findViewById(R.id.btn_add_project);
    ...
    public void showDeleteDialog(final String id, final  int position) {
        final AlertDialog alertDialog = new AlertDialog.Builder(getActivity())
                .setTitle("Do you want to delete the Project ?")
    ...
    public void showFinishedTaskDialog(final String id, final int position) {
        final AlertDialog alertDialog = new AlertDialog.Builder(getActivity())
                .setTitle("Move to completeded project?")
                .setPositiveButton("Yes", null)
            ...
            public void onResponse(JSONObject response) {
                try {
                    if(response.getBoolean("success")) {
                        JSONArray jsonArray = response.getJSONArray("TaskManagements");
